...
public class TalkController {
	...
	@RequestParam(defaultValue="1") int pageNum,
		...
		//페이지 처리
		PagingUtil page = new PagingUtil(null,keyword,pageNum,
	...
	public String talkRoomSubmit(TalkRoomVO vo, 
			HttpSession session) {
		log.debug("<<채팅방 생성>> : " + vo);
	...
	public String talkDetail(long talkroom_num,Model model,
			                 HttpSession session) {
		String chatMember = "";
		String room_name = "";
