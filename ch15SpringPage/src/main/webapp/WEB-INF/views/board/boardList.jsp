		...
		<ul class="search">
			<li>
				<select name="keyfield" id="keyfield">
					<option value="1" <c:if test="${param.ketfield == 1}">selected</c:if>>제목</option>
					<option value="2" <c:if test="${param.ketfield == 2}">selected</c:if>>작성자</option>
					<option value="3" <c:if test="${param.ketfield == 3}">selected</c:if>>내용</option>
					<option value="4" <c:if test="${param.ketfield == 4}">selected</c:if>>제목+내용</option>
				</select>
			</li>
			<li>
